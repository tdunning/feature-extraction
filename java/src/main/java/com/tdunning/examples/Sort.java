...
public class Sort {
    ...
    public static void sort(int[] order, int[] values) {
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public static void sort(int[] order, int[] values, int n) {
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public static void sort(int[] order, int[] values, int start, int n) {
     ...
     */
    private static void quickSort(int[] order, int[] values, int start, int end, int limit) {
...
//            checkPartition(order, values, pivotValue, start, low, high, end);
     ...
     */
    @SuppressWarnings("SameParameterValue")
    private static void insertionSort(int[] order, int[] values, int start, int n, int limit) {
